...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
         ...
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getFirebase() {
        ...
        /**
         * Creates a dependency provider for kakao (com.kakao.sdk:v2-all)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKakao() {
            return create("kakao");
    }
        ...
        /**
         * Creates a dependency provider for naver (com.navercorp.nid:oauth)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getNaver() {
            return create("naver");
    }
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         */
        public ComposeHiltLibraryAccessors getHilt() {
            return laccForComposeHiltLibraryAccessors;
        }
    ...
    public static class ComposeHiltLibraryAccessors extends SubDependencyFactory {
        ...
        public ComposeHiltLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             */
            public Provider<MinimalExternalModuleDependency> getNavigation() {
                return create("compose.hilt.navigation");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: kakao (2.15.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: naver (5.6.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getNaver() { return getVersion("naver"); }
    ...
    public static class ComposeVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        private final ComposeHiltVersionAccessors vaccForComposeHiltVersionAccessors = new ComposeHiltVersionAccessors(providers, config);
        public ComposeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the version associated to this alias: compose (1.6.4)
         * If the version is a rich version and that its not expressible as a
         * single version string, then an empty string is returned.
         * This version was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Returns the group of versions at versions.compose.hilt
         */
        public ComposeHiltVersionAccessors getHilt() {
            return vaccForComposeHiltVersionAccessors;
        }

    }

    public static class ComposeHiltVersionAccessors extends VersionFactory  {

        public ComposeHiltVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: compose.hilt.navigation (1.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getNavigation() { return getVersion("compose.hilt.navigation"); }
    ...
    public static class FirebaseVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        public Provider<String> asProvider() { return getVersion("firebase"); }
            ...
            /**
             * Returns the version associated to this alias: firebase.bom (32.8.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class OrgJetbrainsKotlinVersionAccessors extends VersionFactory  {
        ...
        public OrgJetbrainsKotlinVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: org.jetbrains.kotlin.android (1.9.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
